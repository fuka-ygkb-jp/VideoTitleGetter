...
namespace Yugen.Tools.Web.Scraper
{
    ...
    class NyaaSiScraper : IScraper
    {
        ...
        const string cFileNameListXPath = @"//table[contains(@class, ""torrent-list"")]/tbody/tr/td[2]/a[last()]";
        // ホントはa[@class ne "comments"]とやりたいけど、HtmlAgilityPackが対応していない？
        #endregion
        ...
        /// <remarks>
        ///     2019/03/25  nyaa.siはHtml Agility Pack 1.5.1.0だと漢字表記が文字化けで動作不良
        ///                 1.11.0.0に上げると解消
        /// </remarks>
